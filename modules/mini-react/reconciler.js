...
import { scheduleHooksUpdate } from './render.js';
...
function useState(initial) {
    ...
    actions.forEach(action => {
        // console.log("foreach action => ", action);
        // console.log("foreach hook => ", hook);
...
function reconcileChildrenArray(wipFiber, newChildElements) {
    ...
    while (index < elements.length || oldChildFiber) {
        ...
        const sameType =
            oldChildFiber && element && oldChildFiber.type === element.type;
